...
df = pd.read_csv('tj_mcconnell_spider.csv')
selected_seasons = ['2023-24', 'Career', 'League Average']
...
fig.text(0.5, 0.965, 'TJ McConnell 2023-2024 Season Offensive Efficiency Breakdown (stats via Basketball-Reference)',
             horizontalalignment='center', color='black', weight='bold',
             size='large')

img = Image.open('tj_mcconnell_face.png')
